...
window.SITE_CONTENT = {
  ...
  doctor: {
    ...
    introduction: "上田敬博医師は、2009年から自家培養表皮を用いた熱傷治療に携わり、2023年に毛根再生医療を開始。自分自身の組織を治療に生かす臨床経験を、髪の悩みに向き合う治療へつなげています。",
    ...
    procedurePhotos: [
      {
        ...
        width: 960,
        height: 731,
        alt: "手袋をした手で採取組織を処理している場面",
        label: "採取組織の処理",
        caption: "採取した組織を処理し、注入に向けた準備を進めます。",
  ...
  medical: {
    ...
    purpose:
      "毛髪の太さや密度の改善、発毛の促進が期待できる治療です。細くなった髪や、気になるボリュームに、自分自身の組織を用いてアプローチします。",
    purposeNote:
      "効果には個人差があり、十分な効果が得られない場合もあります。完全な無毛部では効果が限定的な場合があります。",
    duration: "30〜60分程度",
    highlights: [
      { title: "採取する組織は少量", text: "局所麻酔を行い、耳の後ろから米粒大の皮膚組織を少量採取します。" },
