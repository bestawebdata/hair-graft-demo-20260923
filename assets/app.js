(() => {
  ...
  const equipmentPanel = `<div class="wrap equipment-feature" aria-labelledby="equipment-title">
    <figure class="equipment-main">${sourceImage(V.equipment)}<figcaption><span>組織を微細化する機器</span>${escape(V.equipment.name)}</figcaption></figure>
    <div class="equipment-copy"><p class="eyebrow">EQUIPMENT & PROCESS</p><h3 id="equipment-title">治療に用いる機器を、<br>写真で知る。</h3><p>専用カートリッジとリジェネラ装置を用いて、採取した組織から注入液を作成します。</p>
  ...
  document.getElementById("page-details").innerHTML = `
    <section id="about" class="section about"><div class="wrap two-column">
      <div class="section-heading"><p class="eyebrow">ABOUT THE TREATMENT</p><h2>自分の組織で、<br>髪の太さと密度にアプローチ。</h2><span class="section-number" aria-hidden="true">01</span></div>
