(() => {
  ...
  function renderCases() {
    ...
    if (!approved.length) {
      gallery.innerHTML = `<div class="case-placeholder"><span class="photo-symbol" aria-hidden="true">＋</span><h3>症例写真掲載予定</h3><p>経過を比較できるよう、撮影条件をそろえて記録します。</p><div class="case-timeline"><span>施術前</span><i aria-hidden="true"></i><span>経過写真</span><i aria-hidden="true"></i><span>継続記録</span></div><small>撮影・掲載時期は医師と調整のうえ決定します。</small></div>`;
      return;
    }
